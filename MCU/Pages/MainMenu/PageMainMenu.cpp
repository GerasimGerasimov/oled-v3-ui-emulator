...
TPageMainMenu::TPageMainMenu(std::string Name)
    ...
    AddList({
        Container = new TVerticalContainer(pLabelsProps, {
            ...
            new TLinkLabel("Защиты от генераторного режима", "GeneratorProtection", LabelInit),
            new TLinkLabel("Защиты от асинхронного хода", "AsynchronousProtection", LabelInit),
            new TLinkLabel("Работа с УПП", "UPP", LabelInit),
