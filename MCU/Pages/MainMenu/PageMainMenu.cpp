...
TPageMainMenu::TPageMainMenu(std::string Name)
    ...
    AddList({
        Container = new TVerticalContainer(pLabelsProps, {
            ...
            new TLinkLabel("Флаги готовности", "ErrorFlags", LabelInit),
            new TLinkLabel("Флаги работы", "OperationFlags", LabelInit),
            new TLinkLabel("Показания датчиков", "Sensors", LabelInit),
            new TLinkLabel("Плотность", "Density", LabelInit),
            new TLinkLabel("Отладочная информация", "DebugInfo", LabelInit),
            new TLinkLabel("Дискретные входы", "DIn", LabelInit),
            new TLinkLabel("Дискретные выходы", "DOut", LabelInit),
            new TLinkLabel("Уставки связи", "Connection", LabelInit),
