...
TPageControlParameters::TPageControlParameters(std::string Name) : TPageSensors(Name) {
  ...
  LabelInitH.caption = "Контрольные параметры";
...
void TPageControlParameters::fillPageContainer(void) {
  ...
  TagList->AddList({
      ...
      new TTagLine("Напр.Тах.ген.", "U1/RAM/Utg/", LabelInit),
      new TTagLine("Напр.потен-ра", "U1/RAM/Uref/", LabelInit),
      new TTagLine("Угол упр-я", "U1/RAM/A/", LabelInit),
