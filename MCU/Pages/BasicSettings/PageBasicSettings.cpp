...
void TPageBasicSettings::fillPageContainer(void) {
    ...
    TagList->AddList({
        ...
        new TTagLine("UmaxSpR", "U1/FLASH/UmaxSpRect/", LabelInit),
        new TTagLine("UminSpR", "U1/FLASH/UminSpRect/", LabelInit),
        new TTagLine("FmaxSpR", "U1/FLASH/FmaxSpRect/", LabelInit),
        new TTagLine("FminSpR", "U1/FLASH/FminSpRect/", LabelInit),
