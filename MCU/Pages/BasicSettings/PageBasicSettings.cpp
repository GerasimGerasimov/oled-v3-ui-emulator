...
void TPageBasicSettings::fillPageContainer(void) {
    ...
    TagList->AddList({
        ...
        new TTagLine("i2tOV_ON_R", "U1/FLASH/i2tOV_ON_R/", LabelInit),
        new TTagLine("i2tOV_OFF_R", "U1/FLASH/i2tOV_OFF_R/", LabelInit),
        new TTagLine("Iz_i2t_R_limit", "U1/FLASH/Iz_i2t_R_limit/", LabelInit),
        ...
        new TTagLine("fUloadMaxTime", "U1/FLASH/fUloadMaxTime/", LabelInit),
    });
}
