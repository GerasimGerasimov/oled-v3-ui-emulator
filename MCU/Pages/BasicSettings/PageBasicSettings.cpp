...
void TPageBasicSettings::fillPageContainer(void) {
    ...
    TagList->AddList({
        ...
        new TTagLine("UmaxSp", "U1/FLASH/UmaxSpRect/", LabelInit),
        new TTagLine("UminSp", "U1/FLASH/UminSpRect/", LabelInit),
        new TTagLine("FmaxSp", "U1/FLASH/FmaxSpRect/", LabelInit),
        new TTagLine("FminSp", "U1/FLASH/FminSpRect/", LabelInit),
