...
void TPageBasicProtectionsSettings::fillPageContainer(void) {
    ...
    TagList->AddList({
        ...
        new TTagLine("class_time", "U1/FLASH/class_time/", LabelInit),
        new TTagLine("trip_level", "U1/FLASH/trip_level/", LabelInit),
        new TTagLine("return_ratio", "U1/FLASH/return_ratio/", LabelInit),
