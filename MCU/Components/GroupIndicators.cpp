...
{
	TGrahics::outText(sparksV, ElementRect.Left + 2, ElementRect.Top + 29, abs(colorState - 1), "Verdana12");
...
void GroupIndicators::update(const TSlotHandlerArsg& args, const char* format)
{
	...
	try {
		//TGrahics::outText(outValue1, ElementRect.Left + 2, ElementRect.Top + 8, std::fabs(colorState - 1), "Verdana12");
