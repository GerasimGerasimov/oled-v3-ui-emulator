...
int IniParser::getTagString(char* position) {
    /*TODO в общем надо просто брать строку от начала до CRLN или [ или конца ресурса (дл€ну-то знаю)
    а далее смотреть еЄ на предмет информативности
    - если CRLF - пропускать идти к следущей
    - если начинаетс€ с ";" то это камент - пропустить на дину камента
    */
