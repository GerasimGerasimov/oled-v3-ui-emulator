...
/*TODO ѕроверить: эта функци€ ни где не используетс€?*/
...
//tag = "U1/RAM/Iexc/"
//узнать какой DEVx €вл€етс€ описанием дл€ Ux цстройства
...
TValueSearchStruct IniResources::TagToValueSearchStruct(const std::string& tag) {
	...
	if (v.size() == 3) {
		/*TODO тут €вно плохое место! два взаимозависимых модул€
		эти модули нельз€ переставить местами при инициализации!
		сначала инициализаци€ IniResources
		потом € могу инициализировать IniSlotsProps
		а тут € использую данные от обоих модулей, св€зываю их
		Ёту функцию надо выделить как статический класс*/
